            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <div class="col-xs-4">
                            <a href="uploadnote.php" class="btn btn-primary">Yeni Not Ekle</a>
                        </div>
                        NOTLARIM
                    </h1>
                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        if (mysqli_num_rows($run_query) > 0) {
                                            while ($row = mysqli_fetch_array($run_query)) {
                                                ...
                                                echo "<td><a href='allfiles/$file' target='_blank' style='color:green'>Göster </a></td>";
                                            ...
                                            echo "<script>alert('Şuan yüklü notunuz yok! Şimdi yükleyin? ');
